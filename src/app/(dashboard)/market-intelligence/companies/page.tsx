...
export const metadata = {
  title: 'Companies | Market Intelligence',
  description: 'Browse company profiles from the knowledge base',
};
...
/**
 * Companies page - lists company profiles from the knowledge base.
